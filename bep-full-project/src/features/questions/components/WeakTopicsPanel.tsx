// bep-full-project/src/features/questions/components/WeakTopicsPanel.tsx
...
export default function WeakTopicsPanel({
  title = 'Weak Topics',
  subtitle = 'যেসব topic এ আরও practice দরকার, সেগুলো নিচে দেখুন',
  topics,
  loading = false,
  searchable = true,
  compact = false,
        ...
        <div className="relative overflow-hidden border-b border-white/10 p-6">
          ...
          <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Badge variant="premium">{topics.length} Topics</Badge>
              ...
              {visibleTopics.map((topic, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={[
                      'group relative overflow-hidden rounded-[28px] border border-white/10 bg-[#08111F]/75 p-5 backdrop-blur-xl transition-all duration-300 hover:border-cyan-400/20 hover:bg-white/[0.06]',
                      compact ? 'p-4' : 'p-5',
                    ].join(' ')}
                  >
                    ...
                    <div className="relative z-10 flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
                      ...
                      >
                        <div className="flex flex-wrap items-center gap-2">
                          <h3 className={['font-bold tracking-tight text-white transition group-hover:text-cyan-100', compact ? 'text-lg' : 'text-xl'].join(' ')}>
                            {topic.topic}
                          </h3>
