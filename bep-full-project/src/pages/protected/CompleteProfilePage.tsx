// bep-full-project/src/pages/protected/CompleteProfilePage.tsx
...
function calculateCompletion(values: CompleteProfileValues) {
  const fields = [
    values.fullName,
    values.username,
    values.email,
...
export default function CompleteProfilePage() {
  const [values, setValues] =
    useState<CompleteProfileValues>(initialValues);
  ...
  const updateField = <K extends keyof CompleteProfileValues>(
    field: K,
    value: CompleteProfileValues[K],
  ) => {
    setValues((previous) => ({
      ...previous,
      [field]: value,
      ...
      <div className="mx-auto max-w-7xl space-y-6">
            ...
            <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-white/60">
                  আপনার learning journey personalize করতে কিছু basic তথ্য পূরণ করুন।
                  এটি leaderboard, AI suggestions, and community experience improve করবে।
                </p>
              </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <StatCard
            ...
            accent="cyan"
            note="Better subject recommendations"
          />
          <StatCard
            ...
            accent="fuchsia"
            note="More details increase trust"
          />
          <StatCard
            ...
            accent="amber"
            note="Tailored study help enabled"
          />
        </div>
          ...
          >
            <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl">
              <SectionTitle
                ...
                description="Basic identity information যা profile, leaderboard, and community display এ ব্যবহার হবে।"
              />
            ...
            <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl">
              <SectionTitle
                ...
                description="এই information দিয়ে BEP আপনার class, batch, and subject recommendations personalize করবে।"
              />
                  ...
                  {[
                    ...
                    <button
                      ...
                      onClick={() =>
                        updateField(
                          'language',
                          item.value as CompleteProfileValues['language'],
                        )
                      }
                      className={[
          ...
          <div className="space-y-6">
            <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl">
              ...
              <div className="space-y-3">
                <StepItem
                  ...
                  description="AI assistant more relevant subject and chapter suggestions দিতে পারবে।"
                  done={Boolean(values.fullName && values.educationLevel)}
                />
                <StepItem
                  title="Stronger community trust"
                  description="Verified identity-like profile increases credibility in discussions."
                  done={Boolean(values.avatarUrl || values.bio)}
                />
                <StepItem
                  title="Leaderboard visibility"
                  description="Profile details make your name and progress look more complete."
                  done={Boolean(values.username && values.location)}
                />
                <StepItem
                  title="Personalized study flow"
                  description="Class, batch, and language help BEP tailor the experience."
                  done={completion >= 70}
                />
              </div>
            </div>
            ...
            <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl">
              ...
              <div className="space-y-3">
                <ChecklistRow
                  label="Full name"
                  done={Boolean(values.fullName.trim())}
                />
                <ChecklistRow
                  label="Email"
                  done={Boolean(values.email.trim())}
                />
                <ChecklistRow
                  label="Education level"
                  done={Boolean(values.educationLevel.trim())}
                />
                <ChecklistRow
                  label="Class / Batch"
                  done={Boolean(values.className.trim())}
                />
                <ChecklistRow
                  label="Avatar or bio"
                  done={Boolean(values.avatarUrl.trim() || values.bio.trim())}
                />
              </div>

              <div className="mt-5 rounded-2xl border border-cyan-400/15 bg-cyan-400/10 p-4">
                <p className="text-sm leading-7 text-white/75">
                  A complete profile helps the platform personalize practice,
                  weak topic suggestions, and community experience.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-[32px] border border-white/10 bg-[#08111F]/75 p-5 backdrop-blur-xl">
              ...
              <p className="text-sm leading-7 text-white/65">
                আপনার তথ্য learning experience উন্নত করতে ব্যবহার হবে। আপনি চাইলে পরবর্তীতে
                profile settings থেকে এগুলো update করতে পারবেন।
              </p>
            </div>
          </div>
        </div>
